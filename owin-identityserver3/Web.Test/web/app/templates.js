angular.module("templates").run(['$templateCache', function(a) { a.put('web/app/views/user.html', '<div class="row">\n' +
    ...
    '    </div>\n' +
    '</div>');
	a.put('web/app/views/signup.html', '<form role="form" name="registrationForm">\n' +
    '    <div class="row">\n' +
    ...
    '    </div>\n' +
    '</form>');
	a.put('web/app/views/logmessage.html', '<div class="row">\n' +
    ...
    '    </div>\n' +
    '</div>');
	a.put('web/app/views/login.html', '<form role="form" name="loginForm">\n' +
    '    <div class="row">\n' +
    '        <div class="col-md-4 col-md-offset-4">\n' +
    '            <fieldset>\n' +
    ...
    '    </div>\n' +
    '</form>');
	a.put('web/app/views/loghttp.html', '<div class="row">\n' +
    '    <div class="col-md-4 col-md-offset-2">\n' +
    '        <div class="form-group">\n' +
    '            <label for="logLevel">Level</label>\n' +
    '            <select class="form-control" id="logLevel" ng-model="filter.LogLevel" ng-options="option as option for option in logLevels" ng-change="filter.onChange()">\n' +
    ...
    '    </div>\n' +
    '</div>');
	a.put('web/app/views/home.html', '<div class="row">\n' +
    '    <div class="col-md-4 col-md-offset-2">\n' +
    '        <h2>Login</h2>\n' +
