...
describe('log message controller test', function () {
    ...
    it('load controller call log service populate levels', function () {
        ...
        $controller('logHttpController', { $scope: scope, logService: logService });
    ...
    it('load controller call log service populate logs', function () {
        ...
        spyOn(logService, 'getLogHttp').and.returnValue({
            then: function (sucF) {
        ...
        expect(logService.getLogHttp).toHaveBeenCalled();
