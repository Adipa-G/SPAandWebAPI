...
export interface JsonFormatHeighlightState { }

export class JsonFormatHeighlight extends React.Component<JsonFormatHeighlightProps, JsonFormatHeighlightState> {

    constructor(props: JsonFormatHeighlightProps) {
        super(props);
    ...
    render() {
        ...
        var fixedStr = this.props.text.replace(/Bearer [^\s]*/g, "Bearer (token)");
