...
public class IntNullableEnumConverter<T> : JsonConverter<T>
{
    private readonly JsonConverter<T> _converter;
    private readonly Type _underlyingType;

    public IntNullableEnumConverter() : this(null) { }

    public IntNullableEnumConverter(JsonSerializerOptions options)
    {
