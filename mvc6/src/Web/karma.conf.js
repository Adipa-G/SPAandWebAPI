module.exports = function (config) {
    config.set({
        ...
        files: [
          ...
          './web/app/app.js',
          '../../src-test/Web.Test/web/lib/angular-mocks.js',
          '../../src-test/Web.Test/web/app/spec_helper.js',
          '../../src-test/Web.Test/web/app/templates.js',
          '../../src-test/Web.Test/web/app/**/*Test.js'
        ],
        exclude: [
        ],
        preprocessors: {},
