...
namespace Web.Test.Controllers
{
    ...
    public class LogControllerTest
    {
        ...
        public void GivenLevels_WhenLevels_ThenReturn()
        {
            ...
            var result = _controller.Levels() as HttpOkObjectResult;
        ...
        public void GivenLoggers_WhenLoggers_ThenReturn()
        {
            ...
            var result = _controller.Loggers() as HttpOkObjectResult; 
        ...
        public void GivenLogMessages_WhenLogMessages_ThenReturn()
        {
            ...
            var result = _controller.LogMessages(new LogMessageListRequest()) as HttpOkObjectResult; 
        ...
        public void GivenLogHttp_WhenLogHttp_ThenReturn()
        {
            ...
            var result = _controller.LogHttp(new LogHttpListRequest()) as HttpOkObjectResult; 
